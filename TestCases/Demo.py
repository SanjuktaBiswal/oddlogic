...
class Test_DemoTestcase():
    ...
    def test_initialize(self,initialize,get_browser):
        ...
        self.generic = Generic( config_file,config_data,self.excel,self.data, self.driver,scriptName,Test_DemoTestcase.__name__)
    ...
    def test_run(self):
            try:
                ...
                if self.generic.config_data.sNewTestCaseName == "":
                    self.generic.config_data.sNewTestCaseName  = 'Test_DemoTestcase';
