...
class Test_DummyRegistrationForm():
    ...
    def test_initialize(self,initialize,get_browser):
        ...
        self.generic = Generic( config_file,config_data,self.excel,self.data, self.driver,scriptName,Test_DummyRegistrationForm.__name__)
    ...
    def test_run(self):
            try:
                ...
                if self.generic.config_data.sTestcaseId == "":
                    self.generic.config_data.sTestcaseId = 'TS0001_01'
                ...
                if self.generic.config_data.sNewTestCaseName == "":
                    self.generic.config_data.sNewTestCaseName  = 'Test_DummyRegistrationForm';
                ...
                self.generic.func_TCObjective ('Enter Details In Registration Form\nExpectedResult:Data Should Be Saved Properly');
