...
class Test_LoginTest():
    ...
    def test_initialize(self,initialize,get_browser):
        ...
        self.generic = Generic( config_file,config_data,self.excel,self.data, self.driver,scriptName,Test_LoginTest.__name__)
    ...
    def test_run(self):
        try:
            ...
            if self.generic.config_data.sTestcaseId == "":
                self.generic.config_data.sTestcaseId = 'TS0002_01'
            ...
            if self.generic.config_data.sNewTestCaseName == "":
                self.generic.config_data.sNewTestCaseName  = 'Test_LoginTest';
            ...
            self.generic.func_TCObjective ('Validate Login');
