...
def app():
    ...
    tokenizer=pd.read_pickle("./files_prediction/base_V11_tokenizer.pickle")   
    ...
    if st.session_state['customer'] =="Customer 1":
        ...
        labels_index = pd.read_pickle('files_prediction/base_V11_labels_dict.pickle')
    ...
    if st.session_state['customer'] =="Customer 2":
        if st.session_state['option'] =="Transfered Model":
            ...
            labels_index = pd.read_pickle('./files_prediction/cust2_V11_labels_dict.pickle')
            if st.session_state['chkbox_csv_file']:
                df=st.session_state['user_data']
            else:
    ...
    if st.session_state['customer'] =="Customer 3":
        if st.session_state['option'] =="Transfered Model":
            ...
            labels_index = pd.read_pickle('./files_prediction/customer3_transfered_V11_labels_dict.pickle')
